...
//   return (
//     <div>
//       <h2 className="text-2xl font-bold mb-4">Our Department</h2>
...
//               <li
//                 key={department.name}
//                 className={`flex items-center py-2 px-4 cursor-pointer hover:bg-teal-200  ${
...
//                 className="w-full lg:w-1/2 object-cover rounded-lg mb-4 lg:mb-0 lg:mr-8"
//               />
//               <div>
  ...
  return (
    <div className="bg-[#f2f2f2]">
      ...
      <div className="container mx-auto p-4 mt-36 ">
        <h2 className="text-2xl font-bold mb-4 text-center text-[2.5rem]">
          Our Department
        </h2>
