      ...
      <div className="flex flex-col lg:flex-row justify-around items-center relative z-10">
        ...
        <div className="flex-1 text-center lg:text-left lg:px-8">
          <div className="flex items-center gap-4 justify-center lg:justify-start mb-2">
            ...
            <span className="font-bold text-secondary text-[2.5rem]">
              MediConnect
            </span>
          </div>

          <p className="mb-4 text-justify">
            MediConnect is an innovative healthcare platform designed to
            simplify the process of booking and managing medical appointments.
            Our platform connects patients with healthcare providers, making it
            easy to schedule, reschedule, and manage appointments from the
            comfort of your home.
          </p>
          <div>
            <p className="font-bold mb-2 text-[2rem]">Mission Statement</p>
            <p className="text-justify">
              Our mission at MediConnect is to make healthcare accessible and
